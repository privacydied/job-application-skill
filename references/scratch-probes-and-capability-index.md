...
- **combobox** `Please indicate your race` @ `job-boards.greenhouse.io` (role=combobox, aria-controls=react-select-1327-listbox, ctrl=select__control--error select__control--outside-label select) → opened via **pointer-mousedown**; tried pointer-mousedown=ok, arrowdown=ok, trusted-click=ok [2026-08-28]
