...
class TestNoDivergentAntiAiOath(unittest.TestCase):
    ...
    def test_catches_the_plagiarism_phrasing(self):
        """FOURTH miss of this family (2026-08-16). MHCLG/Applied frames it as PLAGIARISM:
        "…presenting the ideas and experience of others, or generated by artificial
        intelligence, as your own", with refusal offered as "I am not eligible to apply".
        It matched nothing — the consequence word was "rejected" (absent from the disqualify
        list) and the possessive was "as YOUR own" while the pair branch only knew "my own"."""
        import atsform  # noqa: PLC0415
        self.assertTrue(atsform.is_anti_ai_oath(
            "I understand that if evidence of plagiarism is found in my application it may be "
            "rejected. Examples of plagiarism can include presenting the ideas and experience "
            "of others, or generated by artificial intelligence, as your own."))

    def test_plain_plagiarism_without_ai_is_not_an_ai_oath(self):
        """The widening must not swallow every plagiarism clause — only ones that make AI the
        thing being attested about."""
        import atsform  # noqa: PLC0415
        self.assertFalse(atsform.is_anti_ai_oath(
            "I confirm this work is my own and not plagiarised from another candidate"))
